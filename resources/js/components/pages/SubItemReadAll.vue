<template>
    <div class="container">
        <div class="list-group">
            <router-link v-for="( subitem, key, index ) in subitems" :key="key" :to="{ name: 'subitem-read', params: { id: subitem.id } }" class="list-group-item">
                {{subitem.subtitle}}
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th style="width: 20%;">Sub content</th>
                        <th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="( subitem, key, index ) in subitems" :key="key" :to="{ name: 'subitem-read', params: { id: subitem.id } }">
                        <td>{{subitem.id}}</td>
                        ...
                        ><i class="material-icons">&#xE254;</i></router-link>
                            ...
                            <a href="#" class="delete" title="Delete" @click.stop.prevent="onDelete(subitem.id, key)"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                </tbody>
            </table>
